...
\begin{circuitikz}[european voltages]
	...
	\draw (s) to[dcisource, l=$gm V_S$] ++(2.5,0) node[circ,label=above right:$D$](d){} to[R, l_=$R_D$, f<=$I_o$] ++(0,-2) node[ground](){};
	\draw (s) -- ++(0,1.5) to[R, label=$R_{DS}$, f<=$I_{DS}$] ++(2.5,0) -- (d);
	\draw (d) ++(0.75,0) node[](vo){} ++(0,-2.5) node[](-vo){};
...
\begin{page}
\begin{circuitikz}[european voltages]
	\node [circ,label=above left:$B_1$](b1){};
	\draw (b1) to[R, l=$R_B$] ++(0,-2) node[ground, label=left:$C_1 \equiv C_2$](){};
