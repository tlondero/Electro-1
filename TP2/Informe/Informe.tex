...
\begin{figure}[H]
\centering
	\includegraphics[width=0.8\textwidth, page=7]{Imagenes/PCB.png}
	\caption{PCB obtenido en Altium.}
\end{figure}

\begin{center}
	\Large{\textcolor{red}{\textbf{ESQUEMÁTICO Y ALGUNA OTRA COSA.}}}
\end{center}

\subsection{Mediciones}
A continuación se procede a analizar los resultados obtenidos de las mediciones sobre el circuito, comparando dichos resultados con los cálculos teóricos y simulados mediante el uso del programa \textbf{LTSpice}.
\begin{figure}[H]
\centering
	\includegraphics[width=0.5\textwidth]{Imagenes/Av.png}
	\caption{Ganancia de tensión del amplificador.}
\end{figure}
\begin{figure}[H]
\centering
	\includegraphics[width=0.5\textwidth]{Imagenes/Avs.png}
	\caption{Ganancia de tensión del sistema.}
\end{figure}
\begin{figure}[H]
\centering
	\includegraphics[width=0.5\textwidth]{Imagenes/Ai.png}
	\caption{Ganancia de corriente del amplificador.}
\end{figure}
\begin{figure}[H]
\centering
	\includegraphics[width=0.5\textwidth]{Imagenes/Ria.png}
	\caption{Impedancia de entrada del amplificador.}
\end{figure}
\begin{figure}[H]
\centering
	\includegraphics[width=0.5\textwidth]{Imagenes/Ris.png}
...
\begin{center}
	\Large{\textcolor{red}{\textbf{HAY QUE REHACER MEDICIONES.}}}\\
	\Large{\textcolor{red}{\textbf{OBSERVACIONES.}}}
\end{center}
