...
De esta forma, seleccionando el componente \href{https://www.mouser.com/datasheet/2/149/2n3819-286408.pdf}{2N3819}, se obtiene de la hoja de datos los valores de interés, tales como % $I_{DSS_{min}} = 2 \ mA$, $V_P = 8.0 \ V$, 
% http://www2.eng.cam.ac.uk/~dmh/ptialcd/jfet/2N3819.pdf  https://www.onsemi.com/pub/Collateral/2N3819-D.PDF
y estableciendo $V_{SS} = 15 \ V$, $R_S = XX \ \Omega$ y $R_D = XX \ \Omega$ se obtiene
\begin{center}
	\LARGE{\textcolor{red}{\textbf{Poner que JFET se usó, datasheet y reemplazar valores.}}} \\
	\LARGE{\textcolor{red}{\textbf{Seleccionar que resistencias usar, $V_{SS}$ y $V_{DD}$.}}}
\end{center}
